			...
			<div class="card card-signin my-5">
				<div class="card-body">
					...
					<div class="memProfileImg">
						<form action="" class="form-img">
							<!--===== 클릭시 사진올라갈 부분  ============= -->							
							<label for="memProfileImg" ><img src="/resources/info/images/profile.png" alt="proImg" id="proImg"/></label> 
							<input type="file" id="memProfileImg" accept="image/*">
					...
					<form class="form-signin" action="">
						...
						<div class="form-label-group">
							...
							<input type="text" name="memTeam" class="form-control" id="memTeam" />
						</div>
						<div class="form-label-group">
							<label for="memGrade">직급</label>
							<input type="text" name="memGrade" class="form-control" id="memGrade" />
						</div>
						<div class="form-label-group">
							<label for="memPhone">휴대폰 번호</label>
							<input type="text" name="memPhone" class="form-control" id="memPhone" />
						</div>
						
						<hr class="my-4">
			            
			              <div class="custom-control custom-checkbox mb-3">
				              <button class="btn btn-lg btn-info btn-block text-uppercase" type="submit">프로필 작성 완료</button>			                
			              </div>
					</form>
				</div>
